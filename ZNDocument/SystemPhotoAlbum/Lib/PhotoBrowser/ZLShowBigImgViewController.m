...
- (void)initCollectionView
{
    ...
    CGFloat height = SCREENT_HEIGHT;
    
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(-kItemMargin/2, 0, kViewWidth+kItemMargin, height) collectionViewLayout:layout];
