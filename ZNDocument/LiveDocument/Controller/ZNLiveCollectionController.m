...
@interface ZNLiveCollectionController ()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureAudioDataOutputSampleBufferDelegate>
...
@implementation ZNLiveCollectionController
...
- (void)viewDidLoad {
    ...
    changeBtn.frame = CGRectMake(10, 10, 30, 30);
    [changeBtn addTarget:self action:@selector(toggleCapture:) forControlEvents:UIControlEventTouchUpInside];
